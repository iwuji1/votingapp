...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { candidate_id: @option.candidate_id, votes: @option.votes } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { candidate_id: @option.candidate_id, votes: @option.votes } }
